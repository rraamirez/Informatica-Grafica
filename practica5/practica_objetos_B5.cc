...
switch (toupper(Tecla1)){
    ...
    // 7 textura (hecha a parte en la entrega de p4)
    case 'I': 
    if(segundaLuz == false){
      segundaLuz = true;
    ...
    // O y P rotacion positova y negativa de segunda luz
        ...
        /*case 'S':if (pulsar_alax==0)
                 ...
                 break;*/
                 /**
                  * SOBRE MOVIMIENTO: NO FUNCIONA AQUI LA ANIMACIÓN CORRECTAMENTE, PARA VER LA ANIMACIÓN
                  * CORRECTA VER ENTREGA P3 O P4. GRACIAS.
                 */
	}
glutPostRedisplay();
}
