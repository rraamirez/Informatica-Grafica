...
class _examenEsfera: public _rotacion
{
public:
       _examenEsfera(float radio=1.0, int latitud=6, int longitud=6);

};

class _examenEsfera2: public _rotacion
{
public:
       _examenEsfera2(float radio=1.0, int latitud=6, int longitud=6);

};


class _examentTroncoFusionPiramide: public _triangulos3D
{
public:
       _examentTroncoFusionPiramide(float t1, float t2, float alt1, float alt2);
