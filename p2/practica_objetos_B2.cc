...
// tipos
typedef enum{CUBO, PIRAMIDE, OBJETO_PLY, ROTACION, EXTRUSION,TRONCO_PIRAMIDE, CILINDRO, CONO, ESFERA, ROTACION_PLY} _tipo_objeto;
...
rotacion_PLY.parametros_PLY("ajedrez",10);
